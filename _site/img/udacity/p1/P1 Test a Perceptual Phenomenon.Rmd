...
```{r, echo=TRUE}
t.test(df$Congruent, df$Incongruent, alternative = c("two.sided"), paired = FALSE,
       var.equal = T, conf.level = 0.95)
```

The confidence level is set at 5%, the t-critical is 2.068, t=-6.53 and the p-value is almost 0 here. The Null Hypothesis is rejected, this matched our expectations from looking at the plots of data.
